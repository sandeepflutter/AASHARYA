          ...
          <div className="flex items-center justify-between h-24 ">
            <div className="flex items-center ">
              <div className="flex-shrink-0">
                ...
                <img alt="logo" src={logo} class=" md:w-15 md:h-10 lg:w-25 lg:h-20  w-25 h-20"/>
                <div>
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                type="button"
                className="bg-cyan-900 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-cyan-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-cyan-800 focus:ring-white"
