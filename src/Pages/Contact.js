...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_mqbktcg', 'template_cc7nz3q', form.current, '-I5xHqX68lSyIjWA7')
      .then((result) => {
...
<section class="text-gray-400 bg-gray-900 body-font relative">
  <div class="container px-5 py-5 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white font-hahmlet">Contact Us</h1>
    </div>
    {status && renderAlert()}
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
          <a href={"https://mail.google.com/mail/?view=cm&fs=1&to=ashrayaengineering824@outlook.com"} target="_blank" rel="noreferrer" class="text-indigo-400">ashrayaengineering824@outlook.com</a>
          <p class="leading-normal font-lora">Kathmandu, Nepal</p>
        </div>
      </div>
    </div>
  </div>
