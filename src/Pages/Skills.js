...
export const Skills = () => {
  return (
    ...
    <p className='sm:text-3xl pb-10 text-2xl font-medium title-font text-black text-center'>Why Choose Us</p>
      <div className="grid row-gap-8 sm:row-gap-0 sm:grid-cols-2 lg:grid-cols-4">
        <div className="p-8 border-b sm:border-r border-blue-500">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">No hidden cost, upfront pricing</h6>
          </div>
        </div>
        <div className="p-8 border-b lg:border-r border-blue-500">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">100% work satisfaction</h6>
          </div>
        </div>
        <div className="p-8 border-b lg:border-r sm:border-r border-blue-500">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Work from registered company</h6>
          </div>
        ...
        <div className="p-8 border-b sm:border-r-0 lg:border-r-0 border-blue-500">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5"> Work done by experinced licenced engineers</h6>
          </div>
        ...
        <div className="p-8 border-b lg:border-b-0 lg:border-r sm:border-r border-blue-500">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Work around your schedules</h6>
          </div>
        </div>
        <div className="p-8 border-b lg:border-b-0 sm:border-r-0 lg:border-r border-blue-500">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">Free professional advices</h6>
          </div>
        </div>
        <div className="p-8 border-b sm:border-b-0 sm:border-r border-blue-500">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5"> No obligation estimations</h6>
          </div>
        </div>
        <div className="p-8">
          <div className="max-w-md text-center">
            ...
            <h6 className="mb-2 font-semibold leading-5">We leave your premises clean & tidy</h6>
          </div>
        </div>
      </div>
    </div>
